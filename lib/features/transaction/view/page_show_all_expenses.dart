                            ...
                            children: [
                              ...
                              Consumer(
                                builder: (context,ref,child) {
                                  ...
                                  final userName = userData?['name'] ?? (user != null ? 'User' : 'Guest');
                                  return Text(
                                    userName,
                                    style: GoogleFonts.manrope(
                                      fontSize: 22,
          ...
          child: Column(
            ...
            children: [
              Container(
                ...
                child: Icon(transaction.icon, color: transaction.color, size: 35),
              ),
              const SizedBox(height: 16),
              Container(
              ...
              _DetailRow(label: 'Date', value: DateFormat('MMM dd, yyyy - hh:mm a').format(transaction.date)),
              ...
              children: [
                Text(
                  ...
                  style: GoogleFonts.manrope(
                    fontSize: 16,
                    fontWeight: FontWeight.bold,
                    color: transaction.isExpense ? const Color(0xFFE57373) : const Color(0xFF66BB6A),
                  ),
                ),
                if (transaction.description.isNotEmpty)
                  Padding(
