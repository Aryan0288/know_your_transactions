...
/// Common Text
Text commonTextStartAlign({required String title, required TextStyle style,TextAlign textAlign = TextAlign.start}) {
  return Text(title, style: style, textAlign: textAlign,textDirection: TextDirection.ltr);
}
...
TextStyle get headingTextStyle_438883 => TextStyle(
  fontSize: 28,
  fontFamily: manRopeBold,
  color: textColor_438883,
);
